...
It might also work for other products, such as Raman spectrometers, but in these cases, additional adjustments may be needed to support new block types (for  
...
dedicated part of the file header.
...
This example spectrum was measured with atmospheric compensation (removing masking information from carbon dioxide and water vapor bands), as set in the
OPUS software. 
