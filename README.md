...
We from [spectral-cockpit team](https://github.com/spectral-cockpit) are happy to offer consulting service along your entire spectroscopy workflow. This package shares a state-of-the-art binary reader with the R community. You can help us further to support/map more and more instruments, measurement modes and block types. We can recommend the package as a solid foundation for your spectroscopy workflow. Also you can soon rely on our ready-made solutions building upon it, thanks to:
